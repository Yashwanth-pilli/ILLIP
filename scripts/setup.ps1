...
Write-Host "1. Start backend:  .\scripts\run_backend.ps1" -ForegroundColor White
Write-Host "2. Start frontend: .\scripts\run_frontend.ps1" -ForegroundColor White
Write-Host "3. Or both:        .\scripts\dev_start.ps1" -ForegroundColor White
Write-Host ""
